...
export default ({
    ...
    const defaultFaqs = [
        {
            question: "Я никогда не заказывал товары в США  и не понимаю, как это сделать?",
        ...
        },
        {
            ...
            answer: "На сегодняшний день сроки доставки до Казахстана из США составляют 15-25 дней . В ближайшее врем   я планируется сократить сроки доставки из США в Казахстан до 10-15 дней."
        },
        {
