        ...
        <AnimationRevealPage>
            ...
            <Container>
                <Content>
                    <HeadingColumn>
                        <HeadingDescription>
                            После оформления заказа нужно указать его трекинг-номер на сайте службы доставки. Это поможет избежать ошибок при обработке заказа. После того, как Вы оплатили доставку и указали все необходимые данные, остается только ждать получения товаров. Мы гарантируем, что доставка с Eparcel занимает совсем немного времени.
                            <Break />
                            Заказывать товары онлайн с доставкой в Казахстан – это удобно и выгодно. Главное – выбрать желанные товары и указать правильный адрес склада. Следуя этой простой инструкции, Вы сможете получить свои покупки без проблем и задержек.                        </HeadingDescription>
                    </HeadingColumn>
                </Content>
            </Container>
            <Footer />
