        ...
        <>
            <AnimationRevealPage>
                <Header
                    ...
                    paragraph="При покупке товаров онлайн в других странах с доставкой в Казахстан применяются таможенные законы, правила и условия. Важно учитывать возможные пошлины и ограничения, которые могут повлиять на стоимость и срок доставки Ваших товаров."
