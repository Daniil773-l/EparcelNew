            ...
            <Content>
                <HeadingColumn>
                    ...
                    <HeadingDescription>
                        ...
                        Мы  оказываем полный комплекс услуг по логистике и доставке посылок с товарами для
                        физических лиц, купленных на маркетплейсах и в онлайн-магазинах в зарубежных странах.
                        Доставка посылок с товарами из-за границы является нашей основной деятельностью с собственными
                        методами доставки до Казахстана. Доставка посылок производится по всему Казахстану.
                    </HeadingDescription>
                </HeadingColumn>
            </Content>
        </Container>
